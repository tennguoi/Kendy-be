...
// AdminRole adminRole = createRoleIfNotExists("admin", "Administrator role with
// full system access");
// AdminRole doctorRole = createRoleIfNotExists("bac_si", "Doctor role for
// medical professionals");
// AdminRole receptionistRole = createRoleIfNotExists("tiep_tan", "Receptionist
...
// System.out.println("Created admin user: nguyenduccongminh34@gmail.com /
// admin123");
// }
...
// // if
// (!userAccountRepository.existsByEmailIgnoreCase("congminh152005@gmail.com"))
// {
...
// // System.out.println("Created doctor user: congminh152005@gmail.com /
// doctor123");
// // }

// // if
// (!userAccountRepository.existsByEmailIgnoreCase("danpham261005@gmail.com")) {
...
// // UserAdminRole receptionistUserRole = new UserAdminRole(receptionist,
// receptionistRole);
// // userAdminRoleRepository.save(receptionistUserRole);
// // System.out.println("Created receptionist user: danpham261005@gmail.com /
// receptionist123");
// // }
